import { SORT } from '@/common/constants/menu';
  ...
  return (
    <>
      <div className="flex justify-between mt-6">
        <Dropdown placeholder="정렬 기준" items={SORT} valueKey={'id'} displayKey="label" />
        <Button variant={'outlined'} size={'medium'} icon={{ DefaultComponent: PlusLine }}>
          새로 만들기
        </Button>
      </div>
      {TEST_DATA.length > 0 && (
      ...
      {TEST_DATA.length > 0 ? (
        ...
        <div className="flex flex-col items-center justify-center mt-10">
          <Image src="/assets/images/empty.png" alt="빈 롤링페이퍼 이미지" width={80} height={80} className="mb-4" />
